...
The finished product will be a fully functional GUI that a user can interact with to encrypt there passwords and it will looks something like this:

![GUI-EX1](/images/pass1.jpg){:class="img-responsive"}

The GUI will be handle any encryption key between 1-9999:
